...
<template>
    ...
    <div class="d-flex justify-content-center">
      <label v-if="sameUser" class="btn btn-add-photo d-flex align-items-center" for="fileUploader" style = "margin-left: -30px; margin-top: 10px;">
        Aggiungi 
        <i class="fas fa-plus"></i>
      </label>

      <input id="fileUploader" type="file" class="profile-file-upload" @change="uploadFile" accept=".jpg" style="display: none;">
    </div>

    <hr class="posts-divider"/>
    
    <div class="row" style="width: 100%;" v-if="!banStatus && postCnt>0">
      <div v-for="(photo) in photos" class="col-sm-4">
        <Photo 
          :key="photo.photo_id" 
